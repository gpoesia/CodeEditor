...
var CodeEditor = React.createClass({displayName: "CodeEditor",
  ...
  render: function() {
    console.log("why");
    return React.createElement("div", {style: this.props.parameters.style, onClick: this.focus}, 
             React.createElement(Editor, {editorState: this.state.state, 
...
CodeEditor.render = function(element, props) {
  ReactDOM.render(React.createElement(CodeEditor, {parameters: props}), element);
};
